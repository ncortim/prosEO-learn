...
my @processors = (
    {
    	...
    	processorVersion => '2.1.1',
    	configuredProcessors => [ 'PTML1B_2.1.1_OPER_2020-03-25' ],
    	tasks => [ 
    	   { taskName => 'ptm_l01b', taskVersion => '2.1.1' }
    	],
    	dockerImage => 'localhost:5000/proseo-sample-wrapper:2.1.1'
    },
    {
        processorName => 'PTML2', 
        processorVersion => '2.1.1',
        configuredProcessors => [ 'PTML2_2.1.1_OPER_2020-03-25' ],
        tasks => [ 
           { taskName => 'ptm_l2', taskVersion => '2.1.1' }
        ],
        dockerImage => 'localhost:5000/proseo-sample-wrapper:2.1.1'
    },
    {
        processorName => 'PTML3', 
        processorVersion => '2.1.1',
        configuredProcessors => [ 'PTML3_2.1.1_OPER_2020-03-25' ],
        tasks => [ 
           { taskName => 'ptm_l3', taskVersion => '2.1.1' }
        ],
        dockerImage => 'localhost:5000/proseo-sample-wrapper:2.1.1'
    }
);
...
my @configured_processors = (
    {
    	identifier => 'PTML1B_2.1.1_OPER_2020-03-25',
    	processorName => 'PTML1B',
    	processorVersion => '2.1.1',
    	configurationVersion => 'OPER_2020-03-25' 
    },
    {
        identifier => 'PTML2_2.1.1_OPER_2020-03-25',
        processorName => 'PTML2',
        processorVersion => '2.1.1',
        configurationVersion => 'OPER_2020-03-25' 
    },
    {
        identifier => 'PTML3_2.1.1_OPER_2020-03-25',
        processorName => 'PTML3',
        processorVersion => '2.1.1',
        configurationVersion => 'OPER_2020-03-25' 
    }
...
my @workflows = (
    {
    	...
    	configuredProcessor => 'PTML3_2.1.1_OPER_2020-03-25',
...
$applicable_processors{'PTM_L1B'} = [ 'PTML1B_2.1.1_OPER_2020-03-25' ];
...
$applicable_processors{'PTM_L2_A'} = [ 'PTML2_2.1.1_OPER_2020-03-25' ];
# Output PTM_L2_B
...
$applicable_processors{'PTM_L2_B'} = [ 'PTML2_2.1.1_OPER_2020-03-25' ];
...
$applicable_processors{'PTM_L3'} = [ 'PTML3_2.1.1_OPER_2020-03-25' ];
